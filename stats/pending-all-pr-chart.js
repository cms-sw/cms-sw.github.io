...
AmCharts.ready(function() {
  var rows = loadCSV("../data/stats/pr-all-open-stats.csv");
  parseCSV(rows);
...
function writeMainTable() {
  for (var i = 0; i < csvData.length; i++) {
    ...
    var repository = csvData[i].repository;
